...
## Status
- Wallet: configured, balance ~0.01966 ETH on Base (≈314 fires at default cost)
- Deploy cadence: cron `*/5 * * * *` (defined in `aeon.yml`)
- Defaults: 25 blocks × 0.0000025 ETH = 0.0000625 ETH per fire
- Pending rewards (last check): 0.000164 ETH, 0.00323 BEAN — well below auto-claim thresholds
